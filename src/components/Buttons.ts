...
import { Minus, Plus, Divider, Multiplier, Operator } from "../data_classes/Operators"
import { $ } from "../utils/helpers"
import { controller } from "../utils/customTypes"
...
class OperatorButton extends Button {
    ...
    constructor(element: HTMLElement) {
        ...
        this.element.onclick = () => {
            this.controller.setOperator(this.operator)
        }
    }
